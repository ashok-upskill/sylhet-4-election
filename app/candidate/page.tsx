      ...
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-8 -mt-8 relative z-20">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <VisionCard 
            ...
            desc="প্রতিটি সমস্যা মনোযোগ দিয়ে শুনব এবং রেকর্ড করব" 
          />
          <VisionCard 
            icon={Target} 
            color="purple"
            title="সমাধানে প্রতিশ্রুতি" 
            desc="সম্ভব হলে তাৎক্ষণিক, না হলে সুনির্দিষ্ট সময়সীমা" 
          />
          <VisionCard 
            icon={CheckCircle2} 
            color="green"
            title="স্বচ্ছ অগ্রগতি" 
            desc="সব অগ্রগতি public-এ দেখানো হবে, before/after সহ" 
          />
        </div>
